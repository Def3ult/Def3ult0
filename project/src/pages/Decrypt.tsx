    ...
    try {
      switch (method) {
        ...
        case 'playfair':
          ...
          decryptedText = playfairCipher(text, key, true);
          break;
        case 'vigenere':
          if (!key) {
            toast.error('الرجاء إدخال كلمة المفتاح');
        ...
        case 'transposition':
          ...
          decryptedText = transpositionCipher(text, shift, true);
          break;
      }
      setResult(decryptedText);
      toast.success('تم فك التشفير بنجاح');
    } catch (error) {
      toast.error('حدث خطأ أثناء فك التشفير');
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-blue-100">
          <h1 className="text-3xl font-bold text-blue-600 mb-8 text-center">فك التشفير</h1>
            ...
            {result && (
              <div className="mt-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg border-2 border-blue-100">
                  <p className="text-gray-800 break-all" dir="auto">
                    {result}
                  </p>
                </div>
              </div>
